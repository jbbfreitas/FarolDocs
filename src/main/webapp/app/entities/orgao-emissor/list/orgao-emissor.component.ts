...
export class OrgaoEmissorComponent implements OnInit {
  ...
  protected onSuccess(data: IOrgaoEmissor[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    if (navigate) {
      this.router.navigate(['/orgao-emissor'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
