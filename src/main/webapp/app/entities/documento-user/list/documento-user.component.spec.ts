...
describe('Component Tests', () => {
  describe('DocumentoUser Management Component', () => {
    let comp: DocumentoUserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [DocumentoUserComponent],
        providers: [
          Router,
          {
        ...
        .overrideTemplate(DocumentoUserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.documentoUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
